...
export default function JoinNetwork() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-50">
      {/* Navigation */}
      <nav className="bg-white shadow-sm border-b border-yellow-100">
      ...
      <section className="pt-16 pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-yellow-100 px-4 py-2 rounded-full text-sm text-yellow-800 font-medium mb-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <br />
            <span className="text-yellow-600">Just Quality Jobs.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-2 border-yellow-300 text-gray-700 hover:border-yellow-500 hover:text-yellow-700 px-8 py-4 text-lg font-semibold rounded-2xl transition-all duration-300"
            >
              Learn More
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Leads per week</div>
            </div>
            <div className="text-center">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Tell us your trade, service areas, project types, and availability. We only send relevant opportunities.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Receive Vetted Leads</h3>
              <p className="text-gray-600">We verify every homeowner's budget, timeline, and commitment before sending you their details.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Win More Work</h3>
              <p className="text-gray-600">Connect directly with serious homeowners ready to move forward. No bidding wars or lowball offers.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-yellow-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-none shadow-lg border border-yellow-100">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-600">Every lead has confirmed budget, timeline, and is ready to proceed. No tire-kickers or unrealistic expectations.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg border border-yellow-100">
              ...
              <CardContent>
                <p className="text-gray-600">Work exclusively in North Sydney, Northern Beaches, and Eastern Suburbs. No long drives or unfamiliar areas.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg border border-yellow-100">
              ...
              <CardContent>
                <p className="text-gray-600">We limit each project to 3 carefully selected tradies. Quality over quantity, fair competition guaranteed.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg border border-yellow-100">
              ...
              <CardContent>
                <p className="text-gray-600">Showcase your best work, collect reviews, and build a strong local reputation that attracts more quality clients.</p>
              </CardContent>
            </Card>
          </div>
        </div>
