...
export default function HeroSection() {
  ...
  return (
    <section className="pt-16 bg-gradient-to-br from-rose-50 via-pink-50 to-red-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm px-4 py-2 rounded-full text-sm text-red-700 font-medium mb-6 border border-red-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
              <Button 
                ...
                className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 text-lg font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
                Get Matched
              ...
              <Button 
                ...
                className="border-2 border-red-200 text-gray-700 hover:border-red-400 hover:text-red-700 hover:bg-red-50 px-8 py-4 text-lg font-semibold rounded-2xl transition-all duration-300"
              >
                See How It Works
              </Button>
            </div>
