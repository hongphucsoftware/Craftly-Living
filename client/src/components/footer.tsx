...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="craftly-navy text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Craftly Living</h3>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 craftly-coral rounded-full flex items-center justify-center hover:bg-red-500 transition-colors duration-200"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-300">
                ...
                <span>hello@craftlyliving.com</span>
              </li>
              <li className="flex items-center text-gray-300">
